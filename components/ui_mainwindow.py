...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        /* Изменяем курсор на указатель при наведении на QComboBox */
        QComboBox {
            cursor: pointer;  /* Устанавливаем курсор pointer */
        }

        /* Фокус и наведение для текста */
        QComboBox:hover {
            font-weight: bold; 
            font-size: 160px;
        ...
        /* Убираем фон у элементов выпадающего меню */
        QComboBox QAbstractItemView {
            background: transparent; /* Прозрачный фон для выпадающего меню */
            border: none;            /* Убираем рамку */
        }

        /* Убираем отображение выбранного элемента */
        QComboBox QAbstractItemView::item:selected {
            color: transparent;      /* Скрываем текст */
            background: transparent; /* Прозрачный фон */
            height: 0px;              /* Скрываем выбранный элемент */
        }

        /* Поправляем отображение невыбранных элементов */
        QComboBox QAbstractItemView::item {
            color: #000000;          /* Цвет невыбранных элементов */
            background: #FFFFFF;     /* Белый фон для остальных элементов */
        }
        """)
        ...
        self.datch_menu.addItem("Выбор датчика")
        ...
        self.load_type_data()
        self.type_menu.currentTextChanged.connect(self.on_type_selected)
    ...
    def load_type_data(self):
        _translate = QtCore.QCoreApplication.translate
        self.type_menu.addItem("Тип датчика")
        for elem in get_sensor_types():
            self.type_menu.addItem(elem)

    def load_datch_data(self, type):
        _translate = QtCore.QCoreApplication.translate
        self.datch_menu.clear()
        self.datch_menu.addItem("Выбор датчика")
        for elem in get_sensors_by_type(type):
            self.datch_menu.addItem(elem['name'])

    def on_type_selected(self, selected_text):
        self.load_datch_data(selected_text)
